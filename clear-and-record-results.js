...
async function clearAndRecordResults() {
  try {
    ...
    console.log('📊 === Clearing and Recording Results (Result: 340 ✅️) ===\n');
    ...
    for (let i = 1; i < rows.length; i++) {
      ...
      // อัปเดตผลลัพธ์ในชีท (Column I-J และ S-T)
